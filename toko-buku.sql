...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2023 at 04:29 AM
...
(1, 'hafizh', 'pandanwangi', 856744, '', 'fiz123', '7363a0d0604902af7b70b271a0b96480', 'admin'),
(4, 'hafizh', 'sanan', 8213198, '', 'fizz', '202cb962ac59075b964b07152d234b70', 'admin'),
(5, 'hafizhh', 'jl sanan', 123456, '', 'fiz', '202cb962ac59075b964b07152d234b70', 'pemilik');
...
--
ALTER TABLE `pasok`
  MODIFY `id_pasok` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
